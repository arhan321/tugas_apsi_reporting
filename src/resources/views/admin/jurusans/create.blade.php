...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.jurusan.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.jurusans.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="nama_jurusan">{{ trans('cruds.jurusan.fields.nama_jurusan') }}</label>
                <input class="form-control {{ $errors->has('nama_jurusan') ? 'is-invalid' : '' }}" type="text" name="nama_jurusan" id="nama_jurusan" value="{{ old('nama_jurusan', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kode_jurusan') ? 'is-invalid' : '' }}" type="text" name="kode_jurusan" id="kode_jurusan" value="{{ old('kode_jurusan', '') }}">
